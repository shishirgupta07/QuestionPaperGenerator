...
<div class="card">
    <h5  class="card-header white-text text-center py-4" style="background-color: #4b3e8a" >
      ...
      <div class="card-body px-lg-5 pt-0">
       <form class="text-center" style="color: #757575;" action="paperPreview.jsp">
            ...
            <select class="browser-default custom-select" id="course_select" name="course_select">
 ...
 %>
           ...
           &nbsp;
            ...
            <select class="browser-default custom-select" id="semester_select" name="semester_select">
  <option value="" readonly>select semester</option>
            </select>
             &nbsp;
            <select class="browser-default custom-select" id="subject_select" name="subject_select">
  <option value="" readonly>select subject</option>
            </select>
             &nbsp;
            <select class="browser-default custom-select" name="noOfModules">
  ...
  <option value="4">4</option>
             ...
             &nbsp;
            <select class="browser-default custom-select" name="questionPerModule">
