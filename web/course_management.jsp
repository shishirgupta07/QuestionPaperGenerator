   ...
   <tbody>
         ...
         String  qrys="Select * from course" ;
          ...
          while( rss.next()){
            ...
            String course =rss.getString("course_name");
           String duration=rss.getString("course_duration");
    %>
               <tr> 
               <td>
                   <%=course %>
               ...
               <td>
                ...
                <td> 
                <span class="table-remove  white-text"><a href="course_edit.jsp?idc=<%= rss.getString("course_id")%>"><button type="button" style="background-color:#4b3e8a; color:white "
                  ...
                  <span class="table-remove white-text"><!-- Button trigger modal -->
                       <a onclick="remove('<%= rss.getString("course_id")%>')"> <button type="button" style="background-color:#4b3e8a; color:white " class=" btn-rounded btn-sm" data-toggle="modal" data-target="#basicExampleModal">
                        Remove
                           </button></a>
...
<!-- Modal -->
<form action="course_remove.jsp "  method="post">
                               ...
                               <div class="modal-content">
                                     ...
                                     <div class="modal-body">
                                       ...
                                       <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-indigo btn-rounded btn-sm" data-dismiss="modal">Close</button>
   ...
   $(document).ready(function(){
     ...
     $.ajax({
        ...
        success:function(result){
             location.href="course_management.jsp";
        }
    });
 },
